        ...
        <div className="md:flex items-center -mx-10">
          ...
          <div className="w-full md:w-1/2 px-10">
            <div className="mb-10 ">
              ...
              <p className="text-sm">C="Do"  D="Re"  E="Mi"  F="Fa"  G="Sol"  A="La"  B="Si" </p>
              <p className="text-sm">Segun la simbologia que realices escucharas un sonido.</p>

            </div>
            {/* caja traductor */}
            <div className="animate-ping w-8 h-8"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
